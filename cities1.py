...
city_arr = ['Абакан', 'Азов', 'Александров', 'Алексин', 'Альметьевск', 'Анапа', 'Ангарск', 'Анжеро-Судженск', 'Апатиты',
            ...
            'Ейск',
            'Екатеринбург', 'Елабуга', 'Елец', 'Ессентуки', 'Железногорск ', 'Жигулевск', 'Жуковский', 'Заречный',
            ...
            'Комсомольск-на-Амуре', 'Копейск', 'Королев', 'Кострома', 'Котлас', 'Красногорск', 'Краснодар',
            ...
            'Ярославль', 'нью - йорк', 'лос-анджелес', 'чикаго', 'хьюстон ', 'филадельфия', 'финикс', 'сан-антонио',
            'сан-диего',
            'даллас', 'сан-хосе', 'остин', 'джексонвилл', 'сан-франциско', 'индианаполис', 'колумбус', 'форт-уэрт',
            'шарлотт', 'сиэтл', 'денвер', 'эль-пасо', 'детройт', 'вашингтон', 'бостон', 'мемфис', 'нэшвилл', 'портленд',
            'оклахома-сити', 'лас-вегас', 'балтимор ', 'луисвилл', 'милуоки', 'альбукерке', 'тусон', 'фресно',
            'сакраменто', 'канзас-сити', 'лонг-бич', 'меса', 'атланта', 'колорадо-спрингс', 'вирджиния - бич ', 'роли',
            'омаха', 'майами', 'окленд', 'миннеаполис', 'талса', 'уичито', 'новый орлеан ', 'арлингтон', 'кливленд',
            'бейкерсфилд', 'тампа', 'аврора', 'гонолулу', 'анахайм', 'санта-ана', 'корпус-кристи', 'риверсайд',
            'сент-луис ', 'лексингтон', 'стоктон', 'питтсбург', 'сент-пол', 'анкоридж ', 'нью - йорк', 'лос-анджелес',
            'чикаго', 'хьюстон ', 'филадельфия', 'финикс', 'сан-антонио', 'сан-диего', 'даллас', 'сан-хосе', 'остин',
            'джексонвилл', 'сан-франциско', 'индианаполис', 'колумбус', 'форт-уэрт', 'шарлотт', 'сиэтл', 'денвер',
            'эль-пасо', 'детройт', 'вашингтон', 'бостон', 'мемфис', 'нэшвилл', 'портленд', 'оклахома-сити', 'лас-вегас',
            'балтимор ', 'луисвилл', 'милуоки', 'альбукерке', 'тусон', 'фресно', 'сакраменто', 'канзас-сити',
            'лонг-бич', 'меса', 'атланта', 'колорадо-спрингс', 'вирджиния - бич ', 'роли', 'омаха', 'майами', 'окленд',
            'миннеаполис', 'талса', 'уичито', 'новый орлеан ', 'арлингтон', 'кливленд', 'бейкерсфилд', 'тампа',
            'аврора', 'гонолулу', 'анахайм', 'санта-ана', 'корпус-кристи', 'риверсайд', 'сент-луис ', 'лексингтон',
            'стоктон', 'питтсбург', 'сент-пол', 'анкоридж', 'париж', 'марсель', 'лондон', 'барселона', 'токио', 'пекин',
            'хиросима', 'нагасаки', 'стамбул', 'каир', 'стамбул', 'нур-султан']
for i in range(len(city_arr)):
    city_arr[i] = city_arr[i].lower()
